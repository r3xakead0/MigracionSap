...
namespace MigracionSap.Utiles
{
    public class NumeroLetras
    {
        ...
        public string Convertir(double numero, bool mayusculas = false)
        {
            string strNumero = numero.ToString("N2");
            return Convertir(strNumero, mayusculas);
        }
